    ...
    public partial class BL : IBL
    {
        ...
        public void ReleaseDroneFromCharging(int id, TimeSpan time)
        {
            try
            {
                ...
                BO.BaseStation bases = baseStationsBL.Find(bas => bas.BaseStationLocation.Latitude==dro.location.Latitude&& bas.BaseStationLocation.Longitude == dro.location.Longitude);/*(x => x.DronesInCharge.First(y => y.ID == dro.ID) == x.DronesInCharge.First(y => y.ID == dro.ID))*/
